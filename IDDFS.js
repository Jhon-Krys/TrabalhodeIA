...
function IDDFS(estadoInicial, limiteMax = 7) {
    ...
    for (let limite = 0; limite <= limiteMax; limite++) {
        ...
        if (resultado !== null) {
            ...
            console.log("Nós expandidos (IDDFS):", metricas.nosExpandidos);
            console.log("Fator de ramificação médio (IDDFS):", fator.toFixed(2));
            console.log("Memória estimada (IDDFS):", metricas.memoriaMax);
            return resultado;
        }
    }
